/****************************************************************************
** Meta object code from reading C++ file 'next_button.h'
**
...
#error "The header file 'next_button.h' doesn't include <QObject>."
...
void NextButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NextButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
